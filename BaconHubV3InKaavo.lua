...
local Window = Library.CreateLib("Rewind Hub | Blade Ball", "Sentinel")
...
local Credits = Tab4:NewSection("Made By TripleScript In Youtube")
...
Main:NewToggle("Auto Parry", "CK", function(toggled)
...
Main:NewToggle("Hit Effect", "ToggleInfo", function(toggled)
...
Visual:NewToggle("Aiming Mechanism", "ToggleInfo", function(toggled)   loadstring(game:HttpGet("https://raw.githubusercontent.com/Hosvile/Refinement/main/M%3ABlade%20Ball%20Mechanism",true))()
